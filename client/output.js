...
(function($PS) {
  ...
  // s = "{\"text\":{\"simpleText\":\"文字起こしを開く\"},\"icon\":{\"iconType\":\"SUBTITLES\"},\"serviceEndpoint\":{\"clickTrackingParams\":\"CFsQzKsBGAAiEwi0q5inu5PiAhXinMIKHeyuAtc=\""
  // r = "\\{\"text\":\\{\"simpleText\":\"文字起こしを開く\"\\},\"icon\":\\{\"iconType\":\"SUBTITLES\"\\},\"serviceEndpoint\":\\{\"clickTrackingParams\":\"([a-zA-Z0-9=]*)\""
  // r = "\"trackingParams\":\"([a-zA-Z0-9=]*)\""
  // trkprmR = "trackingParams..:..([a-zA-Z0-9=]*)[^a-zA-Z0-9=]"
  // trkprmR = "navigationEndpoint..:...clickTrackingParams..:..([a-zA-Z0-9=_-]*)[^a-zA-Z0-9=_-]"
  ...
  // proc :: String -> Maybe String
  // proc s = (head $ do
  //     l <- split (Pattern "\n") s
  //     pure $ (hush $ m l) >>= identity) >>= identity
  var proc = function (s) {
